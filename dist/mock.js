(function webpackUniversalModuleDefinition(root, factory) {
	...
	*/
                var Mock = {
                    ...
                    setup: function (settings) {
                        console.log(
                            "%c [ [mockjs]: setup settings ]-84",
                            "padding: 3px 10px 3px 0;font-size:14px; background:#cf222e; color:#fff;background-image: linear-gradient( 135deg, #9708CC 0%, #cf222e 100%);",
                            settings
                        );
	...
	*/
                        ...
                        if (!options.rule.parameters) {
                            ...
                            if (
                                ...
                                if (options.rule.parameters[2]) {
                                    ...
                                    options.context.path.push(options.name);
                                    options.context.templatePath.push(
                                        options.name
                                    );
                                    result = Handler.gen(
                                        options.template,
                                    ...
                                    for (i = 0; i < options.rule.count; i++) {
                                        ...
                                        for (
                                            ii = 0;
                                            ii < options.template.length;
                                            ii++
                                        ) {
                                            options.context.path.push(
                                                result.length
                                            );
                                            options.context.templatePath.push(
                                                ii
	            ...
	            */
                            ...
                            for (i = 0; i < keys.length; i++) {
                                ...
                                if (
                                    inc &&
                                    inc[2] &&
                                    Util.type(options.template[key]) ===
                                        "number"
                                ) {
                                    options.template[key] += parseInt(
                                        inc[2],
                                        10
                                    );
                                }
                    ...
                    string: function (options) {
                        ...
                        if (options.template.length) {
                            ...
                            // 'email|1-10': '@EMAIL, ',
                            placeholders =
                                result.match(Constant.RE_PLACEHOLDER) || []; // A-Z_0-9 > \w_
	            ...
	            */
                        ...
                        var handle =
                            Random[key] || Random[lkey] || Random[okey];
                    ...
                    getValueByKeyPath: function (key, options) {
                        ...
                        try {
                            ...
                            var templateCurrentContext =
                                options.context.templateRoot;
                            for (
                                var i = 1;
                                i < absolutePathParts.length - 1;
                                i++
                            ) {
                                currentContext =
                                    currentContext[absolutePathParts[i]];
                                templateCurrentContext =
                                    templateCurrentContext[
                                        absolutePathParts[i]
                                    ];
	 ...
	 */
                ...
                module.exports = {
                    parse: function (name) {
                        ...
                        var dmin =
                            decimal && decimal[1] && parseInt(decimal[1], 10); // || 0,
                        var dmax =
                            decimal && decimal[2] && parseInt(decimal[2], 10); // || 0,
                        // int || dmin-dmax || 0
                        var dcount = decimal
	...
	*/
                module.exports = {
                    ...
                    natural: function (min, max) {
                        min =
                            typeof min !== "undefined" ? parseInt(min, 10) : 0;
                        max =
                ...
                module.exports = {
                    ...
                    _formatDate: function (date, format) {
                        return format.replace(
                            ...
                            function creatNewSubString($0, flag) {
                                return typeof patternLetters[flag] ===
                                    "function"
                    ...
                    now: function (unit, format) {
                        ...
                        if (arguments.length === 1) {
                            // now(format)
                            if (
                                !/year|month|day|hour|minute|second|week/.test(
                                    unit
                                )
                            ) {
                                format = unit;
	...
	*/
		...
		*/
                    order: function order(array) {
                        ...
                        var templatePath =
                            options.context.templatePath.join(".");
	    ...
	    */
	    ...
	    '_': ['\u001F']
                ...
                var OTHER =
                    ...
                    ascii(58, 64) +
                    ascii(91, 96) +
                    ascii(123, 126); // 排除 95 _ ascii(91, 94) + ascii(96, 96)
                    ...
                    "invert-charset": function (node, result, cache) {
                        ...
                        for (var i = 0, item; i < node.body.length; i++) {
                            ...
                            switch (item.type) {
                                ...
                                default:
                                    var characters =
                                        CHARACTER_CLASSES[item.text];
                                    if (characters) {
                                        for (
                                            var iii = 0;
                                            iii <= characters.length;
                                            iii++
                                        ) {
                                            pool = pool.replace(
                                                characters[iii],
	    ...
	    */
                    CONTROL_CHARACTER_MAP: (function () {
                        ...
                        for (var i = 0; i < CONTROL_CHARACTER.length; i++) {
                            map[CONTROL_CHARACTER[i]] =
                                CONTROL_CHARACTER_UNICODE[i];
                        }
                        return map;
                    })(),
                    ...
                    value: function (schema, data, name, result) {
                        ...
                        switch (templateType) {
                            ...
                            case "regexp":
                                actualRepeatCount = data.match(
                                    new RegExp(
                                        schema.template.source.replace(
                                            /^\^|\$$/g,
                                            ""
                                        ),
                                        "g"
	     ...
	     */
                ...
                Util.extend(MockXMLHttpRequest.prototype, {
                    ...
                    open: function (method, url, async, username, password) {
                        ...
                        function handle(event) {
                            ...
                            for (
                                var i = 0;
                                i < XHR_RESPONSE_PROPERTIES.length;
                                i++
                            ) {
                                try {
                        ...
                        if (!item) {
                            ...
                            for (
                                var j = 0;
                                j < XHR_REQUEST_PROPERTIES.length;
                                j++
                            ) {
                                try {
                        ...
                        this.dispatchEvent(
                            new Event(
                                "readystatechange" /*, false, false, this*/
                            )
                        );
                    },
                    ...
                    send: function send(data) {
                        ...
                        function done() {
                            ...
                            responseMock.custom &&
                                Object.keys(responseMock.custom).length &&
                                delete responseMock.custom;

                            that.readyState =
                                MockXMLHttpRequest.HEADERS_RECEIVED;
                            that.dispatchEvent(
                                new Event(
                                    "readystatechange" /*, false, false, that*/
                                )
                            );
                    ...
                    abort: function abort() {
                        ...
                        this.dispatchEvent(
                            new Event("abort", false, false, this)
                        );
                        this.dispatchEvent(
                            new Event("error", false, false, this)
                        );
                    },
                });
                ...
                function createNativeXMLHttpRequest() {
                    ...
                    function createActiveXHR() {
                        try {
                            return new window._ActiveXObject(
                                "Microsoft.XMLHTTP"
                            );
                        } catch (e) {}
                    }
